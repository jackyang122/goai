    ...
    <SidebarDrawerContext.Provider value={{ close }}>
      ...
      <div className="flex h-dvh overflow-hidden">
        ...
        <main className="flex min-w-0 flex-1 flex-col overflow-hidden bg-[var(--background)]">
          ...
          {/* Footer */}
          <footer className="shrink-0 border-t border-[var(--border)] bg-[var(--secondary)] py-2 px-4 text-center text-xs text-[var(--muted-foreground)]">
            © 2026 聆心. All rights reserved. | Powered by deeptutor
          </footer>
        </main>
      </div>
